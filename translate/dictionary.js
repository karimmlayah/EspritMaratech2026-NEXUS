...
const FRENCH_TO_TUNISIAN = {
  ...
  "bouche": ["foum"],
  "dents": ["asnan"],
  "coeur": ["galb", "9alb", "9aleb", "coeur"],
  "yeux": ["3youne", "3youn", "yeux"],
  "nombril": ["sorra"],
  "jambe": ["rijel", "rijl"],
  "aisselle": ["bet", "abti"],
  "fesses": ["mo2akhra"],
  ...
  "bras": ["dhra3", "dhraaa"],
  "cerveau": ["mokh", "mokha", "cerveau","mo5"],
  "ventre": ["batn"],
  "cou": ["ra9ba", "raqba"],
  "cheveux": ["cha3r", "ch3r"],
  "sourcils": ["hawajeb", "7wajeb"],
  "visage": ["wejh", "wejhe","wejah","wejahi"],
  "tête": ["ras","re7s","rasi","raas"],
  "dos": ["dhar"],
  "cuisse": ["fkhadh", "fkhad"],
  "poitrine": ["sadr"],
  "poumons": ["ra2a", "ra2in"],
  ...
  "ou avez vous mal": ["wiene youja3ek", "win youja3ek", "wine youja3ek", "fen youja3ek", "wesh youja3ek", "ash men wejetek", "warien el waja3", "warien te7es b waja3","win te7es b waja3","win t7es b wji3a"],
  ...
  "positif négatif": ["ijabi salbi","moujeb saleb", "mijeb wela salbi", "positif négatif", "ijabi w salbi", "nati9a ijabi wela salbi"],
  "positif negatif": ["ijabi salbi", "moujeb saleb", "mijeb wela salbi", "positif négatif"],
  "attention": ["intibah", "intiba", "entibah", "tnbih", "khoudh balek", "khodh balek", "7ott balek", "attention", "soy 9alek", "intiba","rod belek","rod balek"],
  ...
  "taille": ["khesr", "khasr", "9adech toulék", "el khesr", "taille", "9is el khesr", "toulék chhal", "khesr", "toul","toule","toulék"],

  // Salutations
  "salut ça va": ["ahla bik, kifech", "ahla", "kifech", "labes", "salut", "ça va", "salam", "ahla w sahla", "kifech 7alka", "chbik", "ahla labes", "salut ca va","اهلا لا باس"],
